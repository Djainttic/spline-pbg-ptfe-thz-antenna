...
\title{Spline-Optimized PBG-Enhanced PTFE Patch Antenna for the 0.35 THz Atmospheric Window}

\authors{Djalal Ziani-Kerarti\affil{1} and Fatima Zohra Marouf\affil{2}}

\affiliation{1}{Department of Specialization and Post-Graduation, National Higher School of Telecommunications and ICT, LaRATIC Laboratory, Es-Senia, Oran, Algeria}
\affiliation{2}{Department of Electrical Engineering, National Polytechnic School of Oran, LAAS Laboratory, Es-Senia, Oran, Algeria}

\correspondingauthor{Djalal Ziani-Kerarti}{djalal.zianikerarti@ensttic.dz}

\begin{keypoints}
\item A spline patch antenna is optimized for the 0.35 THz atmospheric transmission window
\item A PTFE photonic band gap substrate improves simulated matching gain and efficiency
\item CST and HFSS simulations provide independent cross validation of the antenna response
\end{keypoints}

\begin{abstract}
The terahertz frequency range offers broad bandwidth for future short range wireless links but places stringent demands on antenna matching and radiation efficiency. This study presents a compact single element microstrip patch antenna for the 0.35 THz atmospheric transmission window. The radiating contour is defined by a quadratic spline whose control points are optimized with a genetic algorithm. A photonic band gap lattice of cylindrical air holes is then integrated into a polytetrafluoroethylene substrate to reduce surface wave transmission near the operating frequency. Full wave simulations were performed independently in CST Microwave Studio using the finite integration technique and ANSYS HFSS using the finite element method. The PBG enhanced design produces a simulated S11 minimum of -44.65 dB at 0.35 THz in CST and approximately -26.28 dB near 0.344 THz in HFSS. Its simulated -10 dB impedance bandwidth is 56.42 GHz, with a peak gain of 7.22 dBi and radiation efficiency of 93.56 percent. A unit cell analysis indicates reduced transmission across the target frequency range, while surface current distributions show reduced spreading around the radiator. The results support the use of spline geometry and substrate level PBG engineering as a compact single element approach for THz antenna research.
\end{abstract}

\section*{Plain Language Summary}
This study develops a very small antenna for future wireless systems that may use terahertz frequencies. The antenna combines a smooth curved metal shape with a patterned substrate containing regularly spaced air holes. Computer simulations show that the patterned substrate improves impedance matching and slightly increases gain and radiation efficiency. The design is evaluated with two independent electromagnetic simulation tools, providing a cross check of the predicted behavior. The antenna is intended as a building block for future terahertz communication systems, although fabrication and measurement remain necessary next steps.

\section*{Keywords}
Terahertz antenna; microstrip patch; photonic band gap; electromagnetic propagation; antenna efficiency; genetic algorithm; PTFE
...
This study did not involve field sampling, human participants, local communities, permits, or region-specific research collaborations. The work was conducted using electromagnetic simulations and institutional research facilities.

\section*{AI Disclosure}
Manus AI and OpenAI-based language assistance were used during manuscript preparation in August 2026 for English grammar and clarity editing, organization and restructuring of selected passages, LaTeX formatting support, bibliography consistency checks, and preparation of the cover letter. These tools were used primarily for the Introduction, Antenna Design and Simulation Methodology, Results and Analysis, Discussion, Benchmarking Against Recent THz Antennas, Conclusion, and cover letter. They were not used to generate or modify electromagnetic simulation data, figures, numerical results, CST or HFSS models, scientific analyses, or conclusions. The authors independently checked the AI-assisted text against the manuscript, simulation outputs, cited publications, bibliography metadata, and final compiled PDF. The authors verified all technical content and remain fully responsible for the accuracy, originality, and integrity of the manuscript. No human-subject data, personal information, confidential industrial information, proprietary simulation files, or unpublished sensitive data were provided to the AI tools.
